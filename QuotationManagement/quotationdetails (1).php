...
<body data-new-gr-c-s-check-loaded="14.1135.0" data-gr-ext-installed="">
    <nav id="menuBar">
        <ul>
        <li>
                <a href=""><i class="bi bi-files"></i><span>Quotation Details</span></a>
            </li>
            <li>
            ...
            <li>
                <a href="logout.php"><i class="bi bi-power"></i><span>Logout</span></a>
            </li>
        </ul>
    </nav>
   ...
   <div id="main_area">
        <div id="topbar" class="template">
            <div id="header">
                <img src="https://static.wixstatic.com/media/8b8f2d_46f5f8aaf3ad4e93b98f0e8a390e19e8~mv2.png/v1/fill/w_117,h_117,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/Overlay%20Dark%20shadowed%20compressed.png" id="logo" style="border-radius:10px;margin-left: 70px;">
                <h1>Calanjiyam Quotation Portal<br>Quotation Details</h1>
            </div>
        ...
        <div class="createbtn">
            <a href="generatebill.php">Generate Quotation</a>
        </div>
              <table id="certificates-details" class="display">
                <thead>
                    <tr>
                        <th class="border-radius-left">QID</th>
                        <th>Customer Name</th>
                        ...
                        <th>Total Amount</th>
                        <th>Edit</th>
                        <th class="border-radius-right">Print</th>
                    </tr>
                </thead>
                <tbody>
                <?php
                ...
                $sql = "SELECT q.qid, c.cname, c.cemail, c.cphone, c.caddress, q.total FROM quotation q JOIN customer c ON q.cid = c.cid";
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<tr>
                            ...
                            <td>" . $row['caddress'] . "</td>
                            <td>" . $row['total'] . "</td>
                            <td><a href='edit.php?qid=$qid' type='submit'><i class='bi bi-pencil'></i></a></td>
                            
                            <td><a href='printpage.php?qid=$qid' target='_blank' type='submit'><i class='bi bi-printer'></i></a></td>
                           </tr>";
                }
