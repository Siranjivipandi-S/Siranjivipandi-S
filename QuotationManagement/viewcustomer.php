...
<body data-new-gr-c-s-check-loaded="14.1135.0" data-gr-ext-installed="">
    <nav id="menuBar">
        <ul>
            ...
            <li>
                <a href=""><i class="bi bi-people"></i><span>Customer Table</span></a>
            </li>
            <li>
    ...
    <div id="main_area">
        <div id="topbar" >
            <div id="header">
                ...
                <h1>Calanjiyam Quotation Portal<br>Customer Table</h1>
            </div>
        ...
        <div class="createbtn">
            <a href="register_customer.php">Create Customer</a>
        </div>
        <form action="">
            ...
            <table>
                <thead>
                    <tr>
                        <th class="border-radius-left">CID</th>
                        <th>Customer Name</th>
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr>
                                ...
                                <td>" . $row['cstatus'] . "</td>
                                <td>" . $row['cinfo'] . "</td>
                                <td><a href='editcustomer.php?cid=$cid' type='submit'><i class='bi bi-pencil'></i></a></td>
                                </tr>";
                            }
