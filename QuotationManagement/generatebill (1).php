    ...
    <div id="main_area">
        <div id="topbar" style="margin-top:10px">
            <div id="header">
                ...
                <h1>Calanjiyam Quotation Portal<br>Generate Quotation</h1>
            </div>
        </div>
        <div class="generate">
            <form action="fetchquotation.php" method="post">
                <div class="title_row">
                   
                    <h4 class="text-center mb-5 mt-2">Customer Details</h4>
                    <a href="register_customer.php">Add New Customer</a>
                </div>
                <select class="form-control" name="product1" id="product1" required>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col"><label for="quotationId">Quotation Name:</label>
                            <input type="text" class="form-control" name="quotationName" id="quotationName" required
                                placeholder="Quotation Name" style="width:300px;"></div>
                        <div class="col"><label for="quotationId">Quotation Description:</label>
                            <input type="text" class="form-control" name="quotationDesc" id="quotationDesc" required
                ...
                <div class="title_row">
                    ...
                    <a href="generate_product.php">Add New Product</a>
                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col">
                                ...
                                <select class="form-control" name="product[]" required>
                                    ...
                                    mysqli_select_db($conn,$dbname);
                                    $sql="SELECT * FROM product where pstatus='ACTIVE'";
...
function addNewItem() {
    ...
    if (container.children.length < maxItems) {
        ...
        alert("You can add a maximum of " + maxItems + " items.");
    }
}
