    ...
    <div id="main_area">
        <div id="topbar" style="margin-top:10px">
            <div id="header">
                ...
                <h1>Calanjiyam Quotation Portal<br>Edit Customer</h1>
            </div>
        </div>
        <?php
        $cid = $_GET['cid'];
        ...
        ?>
        <div class="generate">
            <form action="editcustomerdata.php" method="post">
                <h4 class="" style="padding:5px;text-align:center;">Customer Details</h4>
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            <label for="quotationId">Customer Name:</label>
                            <input value="<?php echo $row['cname']; ?>" type="text" class="form-control" name="customerName" id="customerName" required
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input value="<?php echo $row['cemail']; ?>" type="text" class="form-control" name="customerEmail" id="customerEmail" required
                ...
                <div class="row">    
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input value="<?php echo $row['cphone']; ?>" type="tel" class="form-control" name="customerPhone" id="customerPhone" required
                                placeholder="phoneNumber">
                            </div>

                                 <input value="<?php echo $row['cid']; ?>" type="hidden" class="form-control" name="cid" id="cid" required>
                    </div>
                    <div class="col">
                        <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="customerAddress" id="customerAddress" rows="3" required
                        placeholder="Address" style="height: 50px;"><?php echo  $row['caddress']; ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="customerInformation" id="customerInformation" rows="3" required
                        placeholder="CustomerInformation" style="height: 50px;"><?php echo $row['cinfo']; ?></textarea>
                </div>
